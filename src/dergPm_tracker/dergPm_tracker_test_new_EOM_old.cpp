  ...
  for (int i = 0; i < num_pred_samples_; i++) {
    ...
    // Thesis B
    predicted_load_poses_out.poses.push_back(custom_load_pose); //To change
    predicted_load_velocities_out.poses.push_back(custom_load_vel); //To change
    predicted_load_accelerations_out.poses.push_back(custom_load_acceleration); //To change
